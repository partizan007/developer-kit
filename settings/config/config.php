...
/*---------- TOPIC LIST ----------*/
$config['index']['container_lg'] = 'true'; // Выводить "основные" страницы со списками топиков шире, чем остальные?
...
$config['topic_list']['view'] = 'masonry_4'; // Выбор отображения ленты топиков.
/* Возможные значения:
 * ------- Простые списки ------- *
...
$config['topic']['thumbnail_sm']['text_length'] = '150'; // Длина краткого описания топика для маленькой миниатюры (количество символов).
