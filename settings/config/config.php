...
/* TOPICS */
$config['topic_list']['view'] = 'grid_3'; // Выбор отображения ленты топиков.
/* Возможные значения:
 * - list - стандартный список топиков,
 * - list_big-preview - стандартный список топиков с большим изображением,
 * - grid - сетка миниатюр,
 * - grid_2 - сетка миниатюр с чередующимися большими и маленькими миниатюрами,
 * - grid_3 - сетка миниатюр с первой большой миниатюрой и чередующимися средними и маленькими миниатюрами,
 */
...
/*------- Thumbnail -------*/
$config['topic']['thumbnail']['img_size'] = '750crop'; // Размер превью миниатюры (в соответствии с настройкой плагина «Main Preview»).
$config['topic']['thumbnail']['text_length'] = '200'; // Длина краткого описания топика для миниатюры (количество символов).

$config['topic']['thumbnail_lg']['img_size'] = '750crop'; // Размер превью миниатюры (в соответствии с настройкой плагина «Main Preview»).

$config['topic']['thumbnail_sm']['img_size'] = '750crop'; // Размер превью миниатюры (в соответствии с настройкой плагина «Main Preview»).
