...
/*---------- TOPIC LIST ----------*/
$config['container']['lg'] = 'true'; // Выводить "основные" страницы со списками топиков (без сайдбара) шире, чем остальные?
...
$config['topic_list']['view'] = 'masonry_7'; // Выбор отображения ленты топиков.
/* Возможные значения:
 * ------- Простые списки ------- *
...
/*---------- TOPIC LIST SETTINGS ----------*/
$config['masonry_7']['centerbar'] = 'true'; // Выводить центральную зону для блоков на главной странице?
...
$config['topic']['thumbnail']['text_length'] = '100'; // Длина краткого описания топика для миниатюры (количество символов).
...
$config['topic']['thumbnail_sq']['img_size'] = '751crop'; // Размер превью маленькой квадратной миниатюры (в соответствии с настройкой плагина «Main Preview»).
