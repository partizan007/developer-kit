...
/* Topic (big preview) */
$config['topic']['big_preview']['img_size'] = '750crop'; // Размер превью миниатюры (в соответствии с настройкой плагина «Main Preview»).
/* Рекомендуемый размер изображения для настроек «Main Preview» - 750*300 пикселей. */

$config['topic']['big_preview']['text_length'] = '300'; // Длина краткого описания топика для миниатюры (количество символов).
