...
<div class="col-md-4">
	{if $oTopic->getPreviewImageWebPath()}
		<a href="{$oTopic->getUrl()}"><img class="topic_preview" src="{$oTopic->getPreviewImageWebPath({cfg name='topic.sm_preview_1.img_size'})}"></a>
	{/if}
</div>
...
<div class="col-md-8">
	...
	{if {cfg name='topic.sm_preview_1.text_length'} > 0}
		<div class="topic-content text">
			{$oTopic->getText()|strip_tags|truncate:{cfg name='topic.sm_preview_1.text_length'}:"..."}
		</div>
	{/if}
